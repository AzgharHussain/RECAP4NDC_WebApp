...
const Homepage = () => {
  ...
  const translations = {
    ...
    gu: {
      ...
      heroTitle2: "અને પેટ્રોલિંગ સિસ્ટમ",
  ...
  const FAQ_DATA = language === 'gu' ? [
    ...
    { id: 24, category: 'web',            q: 'વેબ એપ્લિકેશનનો ઉપયોગ શા માટે થાય?', a: 'વેબ એપ્લિકેશન એ સુપરવાઇઝર અને એડમિનિસ્ટ્રેટર માટે જિયો-ડેશબોર્ડ છે:', list: ['કેન્દ્રિત મોનિટરિંગ: બધા પેટ્રોલિંગ ડેટા અને વન આવરણ ફેરફારો મોટી સ્ક્રીન પર જોવા.', 'ડેટા એનાલિસિસ: રિપોર્ટ જનરેટ કરવા અને પેટ્રોલિંગ પ્રદર્શનનું વિશ્લેષણ કરવું.', 'ડેટા એક્સપ્લોર: વિગતવાર વહીવટી સ્તરો જોવા (રાજ્ય, વર્તુળ, વિભાગ, રેન્જ, બીટ, ગામ).', 'NDVI ડેશબોર્ડ: મોટા ક્ષેત્રોમાં વનસ્પતિ સ્વાસ્થ્યનું વિશ્લેષણ.'] },
    { id: 25, category: 'web',            q: 'વેબ એપ્લિકેશનમાંથી કયા રિપોર્ટ જનરેટ કરી શકાય?', a: 'તમે નીચેના વિગતવાર રિપોર્ટ જનરેટ કરી શકો છો:', list: ['પેટ્રોલિંગ લોગ્સ: ફિલ્ટર સાથે બધી પેટ્રોલની વિગતવાર ટેબલ.', 'અધિકારી પેટ્રોલ સારાંશ: અધિકારીના પ્રદર્શન અને પેટ્રોલ વિતરણનો સારાંશ રિપોર્ટ.', 'NDVI રિપોર્ટ્સ: અવનતિ અને વનીકરણ ક્ષેત્રો, વિભાગવાર વિભાજન અને ભૌગોળિક-ટૅગ કરેલ ક્ષેત્ર રેકોર્ડ્સ.'] },
